  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-baseline justify-between">
        ...
        <p className="text-foreground-600">{crew.name}（{crew.position}）</p>
      </div>
        ...
        <Card className="glass-tile border-2 border-primary" shadow="none">
          <CardBody className="flex flex-col gap-3">
            <p className="text-xl">
              ...
              <span className="ml-3 tabular-nums text-foreground-600">
      ...
      <Card shadow="none" className="glass-tile">
        <CardBody className="flex flex-col gap-1">
          <p className="text-sm text-foreground-600">直前の打刻（常時表示・誤操作確認用）</p>
          {lastRecord ? (
            <p>
            ...
            <p className="text-foreground-600">まだ打刻がありません。</p>
          )}
        </CardBody>
      </Card>
    </div>
